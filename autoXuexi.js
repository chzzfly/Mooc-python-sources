...
function refresh(orientation) {
    if (orientation) swipe(mywidth / 2, (myheight * 13) / 15, mywidth / 2, (myheight * 2) / 15, random_time(delay_time / 2));
    else swipe(mywidth / 2, (myheight * 6) / 15, mywidth / 2, (myheight * 12) / 15, random_time(delay_time / 2));
